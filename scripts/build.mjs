...
assets['/pin-state.js'] = { type: 'text/javascript; charset=utf-8', base64: (await readFile(resolve(root, 'src', 'pin-state.js'))).toString('base64') };
assets['/tagging.js'] = { type: 'text/javascript; charset=utf-8', base64: (await readFile(resolve(root, 'src', 'tagging.js'))).toString('base64') };
assets['/supabase-bridge.js'] = { type: 'text/javascript; charset=utf-8', base64: (await readFile(resolve(root, 'src', 'supabase-bridge.js'))).toString('base64') };
