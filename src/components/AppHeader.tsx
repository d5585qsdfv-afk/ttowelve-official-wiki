...
export function AppHeader({entities}:{entities:WikiEntity[]}) { return <header className="app-header"><Link className="brand-lockup" href="/games/juno"><span className="brand-glyph"><span>十</span></span><span className="brand-copy">十の救現主 Wiki</span></Link><GlobalSearch entities={entities}/><Link className="header-link" href="/">ゲーム選択</Link></header>; }
